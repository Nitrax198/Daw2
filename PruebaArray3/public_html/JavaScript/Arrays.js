...
for (var i = 0; i < estadisticas.length; i++) {
    if (estadisticas[i][0] === 2015) {
        sumaAños["2015"] += estadisticas[i][2];
    } else if (estadisticas[i][0] === 2016) {
        sumaAños["2016"] += estadisticas[i][2];
    } else if (estadisticas[i][0] === 2017) {
        sumaAños["2017"] += estadisticas[i][2];
    } else if (estadisticas[i][0] === 2018) {
        sumaAños["2018"] += estadisticas[i][2];
    }
}

for (var i = 0; i < estadisticas.length; i++) {
    switch (estadisticas[i][1]) {
        case 1:
            sumaMeses["Enero"] += estadisticas[i][2];
            break;
        case 2:
            sumaMeses["Febrero"] += estadisticas[i][2];
            break;
        case 3:
            sumaMeses["Marzo"] += estadisticas[i][2];
            break;
        case 4:
            sumaMeses["Abril"] += estadisticas[i][2];
            break;
        case 5:
            sumaMeses["Mayo"] += estadisticas[i][2];
            break;
        case 6:
            sumaMeses["Junio"] += estadisticas[i][2];
            break;
        case 7:
            sumaMeses["Julio"] += estadisticas[i][2];
            break;
        case 8:
            sumaMeses["Agosto"] += estadisticas[i][2];
            break;
        case 9:
            sumaMeses["Septiembre"] += estadisticas[i][2];
            break;
        case 10:
            sumaMeses["Octubre"] += estadisticas[i][2];
            break;
        case 11:
            sumaMeses["Noviembre"] += estadisticas[i][2];
            break;
        case 12:
            sumaMeses["Diciembre"] += estadisticas[i][2];
            break;
    }
}
